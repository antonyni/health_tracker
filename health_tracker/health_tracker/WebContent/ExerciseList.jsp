...
<body>
    ...
    <div align="center">
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="exercise" items="${listExercise}">
                <tr>
                    <td><c:out value="${exercise.id}" /></td>
                    <td><c:out value="${exercise.date}" /></td>
                    <td><c:out value="${exercise.mood}" /></td>
                    <td><c:out value="${exercise.bodyPart}" /></td>
                    <td>
                    	<a href="editExercise?id=<c:out value='${exercise.id}' />">Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deleteExercise?id=<c:out value='${exercise.id}' />">Delete</a>                    	
                    </td>
                </tr>
            </c:forEach>
        </table>
